...
I am currently working on 3D modeling adapters that allow the respiratormask to be attached, I have 1 adapter almost ready for beta and a few more cooking. The long-term goal is to make the system modular to allow users to easily swap parts based on their design needs or the ability to easily relief cut their own 3D design into a compatible part for this system.
...
This is a low profile adapter to allow air supply connections that can fit under a mask. I am considering it a Cyberwear part simply because it is used in a functional rather than ascetic way, but it will be a base component for many other designs that will fall into other categories.
